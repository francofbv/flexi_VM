...
def build_bert(model_config, pretrain, checkpoint):
    ...
    bert_config.encoder_width = model_config.vision_encoder.get.d_model if model_config.vision_encoder.get('d_model', 0) else model_config.vision_encoder.embed_dim
    ...
    if pretrain:
        ...
        print(f'from pretrained: {BertForMaskedLM.from_pretrained}')
